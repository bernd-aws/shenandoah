...
public:
  ...
  //        entry uses different bits of a shared uint16_t to represent
...
public:
  ...
  inline void process_clusters(uint worker_id, ReferenceProcessor* rp, ShenandoahConcurrentMark* cm,
                               uint32_t first_cluster, uint32_t count, HeapWord *end_of_range, ClosureType *oops);
